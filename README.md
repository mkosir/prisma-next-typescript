...
- clone the repo
- `npm run db-start` - Creates Postgres database container instance seeded with Breaking Bad characters and produced batches 💊 (default credentials `user=walter`, `password=white` in [.env file](./envs/.env))
